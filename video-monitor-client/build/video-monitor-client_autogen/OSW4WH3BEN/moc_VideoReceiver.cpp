/****************************************************************************
** Meta object code from reading C++ file 'VideoReceiver.hpp'
**
...
#error "The header file 'VideoReceiver.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 29, 3) // "img"
    ...
    "VideoReceiver\0frameReceived\0\0img"
};
...
void VideoReceiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->frameReceived((*reinterpret_cast< const QImage(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (VideoReceiver::*)(const QImage & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoReceiver::frameReceived)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void VideoReceiver::frameReceived(const QImage & _t1)
{
